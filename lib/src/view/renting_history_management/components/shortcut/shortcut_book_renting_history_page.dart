...
class ShortcutBookRentingHistoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<RentingHistory> rentingHistoryList = Get.find<RentingHistoryService>().getListDataByISBN(book.isbn);
    if (rentingHistoryList.isEmpty) {
      return Center(child: Text("Chưa có lịch sử mượn", style: Theme.of(context).textTheme.headline6));
    }
